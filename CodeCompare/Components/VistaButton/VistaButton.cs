...
namespace VistaButtonTest
{
    ...
    public class VistaButton : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            Paint += new PaintEventHandler(VistaButton_Paint);
            KeyUp += new KeyEventHandler(VistaButton_KeyUp);
            KeyDown += new KeyEventHandler(VistaButton_KeyDown);
            MouseEnter += new EventHandler(VistaButton_MouseEnter);
            MouseLeave += new EventHandler(VistaButton_MouseLeave);
            MouseUp += new MouseEventHandler(VistaButton_MouseUp);
            MouseDown += new MouseEventHandler(VistaButton_MouseDown);
        ...
        private void DrawImage(Graphics g)
        {
            ...
            switch (ImageAlign)
            {
                ...
                case ContentAlignment.MiddleCenter:
                    r =
                        new Rectangle(Width/2 - ImageSize.Width/2, Height/2 - ImageSize.Height/2, ImageSize.Width,
                                      ImageSize.Height);
                    break;
                case ContentAlignment.MiddleRight:
                    r =
                        new Rectangle(Width - 8 - ImageSize.Width, Height/2 - ImageSize.Height/2, ImageSize.Width,
                                      ImageSize.Height);
                    break;
                case ContentAlignment.BottomLeft:
                ...
                case ContentAlignment.BottomCenter:
                    r =
                        new Rectangle(Width/2 - ImageSize.Width/2, Height - 8 - ImageSize.Height, ImageSize.Width,
                                      ImageSize.Height);
                    break;
                case ContentAlignment.BottomRight:
                    r =
                        new Rectangle(Width - 8 - ImageSize.Width, Height - 8 - ImageSize.Height, ImageSize.Width,
                                      ImageSize.Height);
                    break;
            }
            g.DrawImage(Image, r);
